...
number=[one two three four fourfill five six sixfill sixfill2 seven eight eightfill nine ninefill ninefill2 zero zerofill a1];

character=[alphabets number];
Templates=mat2cell(character,42,24*ones(1,51));
